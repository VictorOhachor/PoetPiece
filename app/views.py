...
@app.route('/poems/<string:poem_id>', methods=['GET', 'POST'])
def show_poem(poem_id):
    """Show details about poem with given id."""
    poem = Poem.query.get(poem_id)

    if not poem:
        flash('Poem with given id was not found.')
        return redirect(url_for('show_poems'))
...
@app.route('/poems/<string:poem_id>/edit', methods=['GET', 'POST'])
@is_admin
...
@app.get('/poems/<string:poem_id>/delete')
@login_required
...
@app.route('/poems/<string:poem_id>/add_stanza', methods=['GET', 'POST'])
@login_required
@is_admin
...
@app.get('/poems/<string:poem_id>/stanzas/<string:stanza_id>/delete')
@login_required
@is_admin
...
@app.route('/poems/<string:poem_id>/stanzas/<string:stanza_id>/edit', methods=['GET', 'POST'])
@login_required
@is_admin
...
@app.get('/poems/<string:poem_id>/comments/<string:comment_id>/delete')
@login_required
